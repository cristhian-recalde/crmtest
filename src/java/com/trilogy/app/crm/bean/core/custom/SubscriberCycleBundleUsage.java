...
/**
 * For Historical Bundle Usage
 * @author amedina
 *
 */
public class SubscriberCycleBundleUsage extends com.redknee.app.crm.bean.SubscriberCycleBundleUsage 
{
	  public static final long serialVersionUID = -233697482996424608L;
	        ...
	        throws HomeException
	    {
            ...
            if( eventReason == Constants.BM_ROLLOVER_EVENT || eventReason == Constants.BM_EXPIRY_EVENT)
            {
