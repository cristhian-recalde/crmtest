...
public class PersonalListPlan extends AbstractPersonalListPlan implements LazyLoadBean
{
    ...
    public boolean lazyLoadAllProperties(Context ctx)
    {
        ...
        if (getID()>0)
        {
            try
            {
                final AuxiliaryService auxiliaryService = CallingGroupSupport.getAuxiliaryServiceForPersonalListPlan(
                        ctx, getID());
