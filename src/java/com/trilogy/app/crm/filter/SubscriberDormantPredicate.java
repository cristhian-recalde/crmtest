...
/**
 * This predicate returns true if the Subscriber is in dormant state
 * 
 * @author simar.singh@redknee.com
 * @since 8.2
 */
public class SubscriberDormantPredicate implements Predicate
{
    ...
    public boolean f(Context ctx, Object obj) throws AbortVisitException
    {
        if (obj instanceof Subscriber)
        {
            ...
            try
            {
                ...
                if (sub != null)
                {
                    return SubscriberStateEnum.DORMANT == sub.getState();
                }
            }
