 ...
 */
public class SubscriberAuxiliaryServiceBySubscriberIdentifier
    implements Predicate,XStatement
{
     ...
     */
    public SubscriberAuxiliaryServiceBySubscriberIdentifier(final String subscriberIdentifier)
    {
