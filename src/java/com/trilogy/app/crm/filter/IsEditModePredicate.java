 ...
 */
public final class IsEditModePredicate implements Predicate
{
    /**
     *
     * {@inheritDoc}
    ...
    {
        return OutputWebControl.EDIT_MODE == ctx.getInt(CommonFramework.MODE, OutputWebControl.DISPLAY_MODE);
    }
}