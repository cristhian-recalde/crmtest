 ...
 * @since 9.0
 */
public class DeletableDunningReportPredicate implements Predicate
{
    /**
     * 
     */
    ...
    /**
     * Creates a new DeletableDunningReportPredicate predicate.
     */
    public DeletableDunningReportPredicate()
    {
    }
    ...
    public boolean f(Context ctx, Object obj) throws AbortVisitException
    {
        ...
        if (report!=null)
        {
            return DunningReportStatusEnum.REFRESHING_INDEX != report.getStatus()
