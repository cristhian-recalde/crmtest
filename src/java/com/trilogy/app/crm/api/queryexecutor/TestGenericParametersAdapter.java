 ...
 *
 */
public class TestGenericParametersAdapter extends ContextAwareTestCase
{
    /**
     ...
     */
    public TestGenericParametersAdapter(final String name)
    {
        super(name);
    }
    ...
    public static Test suite(final Context context)
    {
        ...
        final TestSuite suite = new TestSuite(TestGenericParametersAdapter.class);
    ...
    public void testAdapter()
    {
        ...
        GenericParametersAdapter<AccountProfileQueryResults> adapter = new GenericParametersAdapter<AccountProfileQueryResults>(AccountProfileQueryResults.class, "AccountProfile");
        GenericParameter[] adaptResult = null;
        try
        {
            adaptResult = (GenericParameter[]) adapter.adapt(ctx, bean);
            ...
            GenericParameterParser parser = new GenericParameterParser(adaptResult);
            assertEquals("Adapt Bank Address 1 wrong", bankInfo.getAddress1(), parser.getParameter("AccountProfile.Bank.Address1", String.class));
            assertEquals("Adapt Bank Address 2 wrong", bankInfo.getAddress2(), parser.getParameter("AccountProfile.Bank.Address2", String.class));
            assertEquals("Adapt Bank ID wrong", bankInfo.getBankID(), parser.getParameter("AccountProfile.Bank.BankID", String.class));
            assertEquals("Adapt Suspension Reason wrong", accountDetail.getSuspensionReason(), parser.getParameter("AccountProfile.Detail.SuspensionReason", String.class));
            assertEquals("Adapt Bill Cycle wrong", (Long) billing.getBillCycle(), parser.getParameter("AccountProfile.Billing.BillCycle", Long.class));
            assertEquals("Adapt Account State wrong", (Long) profile.getState().getValue(), parser.getParameter("AccountProfile.Profile.State.Value", Long.class));
            assertEquals("Adapt Identification Entry 0 Expiry", param[0].getExpiry().getTimeInMillis(), parser.getParameter("AccountProfile.Identification.Identification.0.Expiry", Calendar.class).getTimeInMillis());
            assertEquals("Adapt Identification Entry 1 Expiry", param[1].getExpiry().getTimeInMillis(), parser.getParameter("AccountProfile.Identification.Identification.1.Expiry", Calendar.class).getTimeInMillis());
            assertEquals("Adapt Identification Entry 2 Expiry", param[2].getExpiry().getTimeInMillis(), parser.getParameter("AccountProfile.Identification.Identification.2.Expiry", Calendar.class).getTimeInMillis());
            assertEquals("Adapt Identification Entry 0 Type", param[0].getType(), parser.getParameter("AccountProfile.Identification.Identification.0.Type", Long.class));
            assertEquals("Adapt Identification Entry 1 Type", param[1].getType(), parser.getParameter("AccountProfile.Identification.Identification.1.Type", Long.class));
            assertEquals("Adapt Identification Entry 2 Type", param[2].getType(), parser.getParameter("AccountProfile.Identification.Identification.2.Type", Long.class));
            assertEquals("Adapt Identification Entry 0 Value", param[0].getValue(), parser.getParameter("AccountProfile.Identification.Identification.0.Value", String.class));
            assertEquals("Adapt Identification Entry 1 Value", param[1].getValue(), parser.getParameter("AccountProfile.Identification.Identification.1.Value", String.class));
            assertEquals("Adapt Identification Entry 2 Value", param[2].getValue(), parser.getParameter("AccountProfile.Identification.Identification.2.Value", String.class));
        }
        catch (Throwable e)
        {
