...
import com.trilogy.app.crm.provision.agent.suspend.AlcatelSuspendAgent;
...
/**
 * 
 * This agent calls the Alcatel SSC Suspend Agent to suspend the Alcatel Service.
 * @author angie.li@redknee.com
 *
 */
public class SuspendAlcatelServiceUpdateAgent implements ServiceStateUpdateAgent
{
            ...
            throws HomeException 
    {
        ...
        AlcatelSuspendAgent agent = new AlcatelSuspendAgent();
        try
        {
