...
public class TransferDisputeAccountBorder
    implements Border
{
        ...
        throws ServletException, IOException
    {
        ...
        where.add(new EQ(TransferDisputeXInfo.CONT_SUB_ACCOUNT, account.getBAN()));
        where.add(new EQ(TransferDisputeXInfo.RECP_SUB_ACCOUNT, account.getBAN()));

        subCtx.put(TransferDisputeHome.class, h.where(ctx, where));
