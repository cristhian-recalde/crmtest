...
import com.trilogy.app.transferfund.rmi.api.transfercontract.RMITransferContractServiceClient;

import com.trilogy.framework.xhome.context.Context;
import com.trilogy.framework.xhome.home.HomeException;

/**
 * An external service implementation for TFA Contract so that it is visible on the system status screen
 */
public class RMITransferContractServiceExternalClient extends RMITransferContractServiceClient
        implements RemoteServiceStatus, PropertyChangeListener
{
    private static final String SERVICE_DESCRIPTION = "RMI client for transfer contract provisioning interface";

    public RMITransferContractServiceExternalClient(Context ctx, String hostname, int port, String service)
    {
        super(ctx, hostname, port, service);
    }

    public RMITransferContractServiceExternalClient(Context ctx, String service) throws HomeException
    {
        super(ctx, service);
    }

    public RMITransferContractServiceExternalClient(Context ctx) throws IllegalArgumentException
    {
        super(ctx);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        else if (TfaRmiConfigXInfo.TRANSFER_CONTRACT_SERVICE_NAME.getName().equals(evt.getPropertyName())
                && newValue instanceof String)
        {
