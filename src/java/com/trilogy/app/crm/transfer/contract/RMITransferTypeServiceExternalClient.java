...
import com.trilogy.app.transferfund.rmi.api.transfertype.RMITransferTypeServiceClient;

import com.trilogy.framework.xhome.context.Context;
import com.trilogy.framework.xhome.home.HomeException;

/**
 * An external service implementation for TFA Transfer Type so that it is visible on the system status screen
 */
public class RMITransferTypeServiceExternalClient extends RMITransferTypeServiceClient
        implements RemoteServiceStatus, PropertyChangeListener
{
    private static final String SERVICE_DESCRIPTION = "RMI client for transfer type provisioning interface";

    public RMITransferTypeServiceExternalClient(Context ctx, String hostname, int port, String service)
    {
        super(ctx, hostname, port, service);
    }

    public RMITransferTypeServiceExternalClient(Context ctx, String service) throws HomeException
    {
        super(ctx, service);
    }

    public RMITransferTypeServiceExternalClient(Context ctx) throws IllegalArgumentException
    {
        super(ctx);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        else if (TfaRmiConfigXInfo.TRANSFER_TYPE_SERVICE_NAME.getName().equals(evt.getPropertyName())
                && newValue instanceof String)
        {
