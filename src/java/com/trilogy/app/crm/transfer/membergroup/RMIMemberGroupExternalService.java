...
import com.trilogy.app.transferfund.rmi.api.membergroup.RMIMemberGroupServiceClient;
import com.trilogy.framework.xhome.context.Context;
import com.trilogy.framework.xhome.home.HomeException;


/**
 * An external service implementation for TFA Member Group so that it is visible on the system status screen
 * 
 */
public class RMIMemberGroupExternalService extends RMIMemberGroupServiceClient implements RemoteServiceStatus, PropertyChangeListener
{

    private static final String SERVICE_DESCRIPTION = "RMI client for transfer funds member group provisioning interface";

    public RMIMemberGroupExternalService(Context ctx, String hostname, int port, String service)
    {
        super(ctx, hostname, port, service);
    }

    public RMIMemberGroupExternalService(Context ctx, String service) throws HomeException
    {
        super(ctx, service);
    }

    public RMIMemberGroupExternalService(Context ctx) throws IllegalArgumentException
    {
        super(ctx);
    }
    ...
    public void propertyChange(PropertyChangeEvent evt)
    {
        ...
        else if( TfaRmiConfigXInfo.MEMBER_SERVICE_NAME.getName().equals(evt.getPropertyName())
                && newValue instanceof String  )
        {
