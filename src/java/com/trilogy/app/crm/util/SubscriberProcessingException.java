...
/**
 * Thrown to indicate that a problem occurred during processing of a subscriber
 * that caused a failure.  This does not prevent the next subscriber from being
 * processed.
 *
 * @author gary.anderson@redknee.com
 */
public
class SubscriberProcessingException
    extends RuntimeException
{
     ...
     */
    public SubscriberProcessingException(
