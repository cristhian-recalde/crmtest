...
/**
 * Represents the Free Call Time Template Creation event record (891) described
 * in the E-Care FS.
 *
 * @author gary.anderson@redknee.com
 */
public final
class FreeCallTimeTemplateCreationEventRecord
    implements EventRecord
{
    /**
     * Creates a new FreeCallTimeTemplateCreationEventRecord for the given
     * template.
     *
     ...
     */
    public FreeCallTimeTemplateCreationEventRecord(final FreeCallTime template)
    {
        if (template == null)
        {
    ...
    public void generate(final Context context)
    {
        new ERLogMsg(
            ...
            new String[]
            {
                ...
                String.valueOf(template_.getName()),
                String.valueOf(template_.getFreeCallTime()),
                String.valueOf(template_.getRollOverMinutes().getIndex()),
                String.valueOf(template_.getMaximumRollOver()),
                String.valueOf(template_.getRollOverPercentage()),
                String.valueOf(template_.getExpiryPercentage()),
                String.valueOf(template_.getUsagePrecedence().getIndex()),
                String.valueOf(template_.getGroupLimit())
            }).log(context);
    }
     ...
     */
    private static final int IDENTIFIER = 891;

    /**
     * The String identifier of the ER.
     */
    private static final String TITLE = "Free Call Time Template Creation Event";
