 ...
 */
public class GemPlusPackageLoaderGroupFilterWebControl extends ProxyWebControl {

    /**
     * Default Constructor
     */
    public GemPlusPackageLoaderGroupFilterWebControl(WebControl delegate) {
	super(delegate);
    }
    ...
    public void toWeb(Context ctx, PrintWriter pWriter, String name, Object obj)
    {
        ...
        catch (UnsupportedOperationException e) 
        {
            ...
            {
                LogSupport.debug(ctx, this, "Exception while getting the Package Group collection for the Technology =" + techEnum.getDescription(), e);
            }
        }
