 ...
 *
 */
public class SerivceNParametersCustomTableWebControl extends ServiceParameterDisplayTableWebControl
{
    ...
    {
        final ServiceProduct serviceNP = (ServiceProduct) ctx.get(AbstractWebControl.BEAN);
        ...
        try
        {
        	parametersList = serviceNP.getServiceParameters();
        	
            template = (ServiceTemplate) serviceTemplateHome.find(ctx, new ServiceTemplateID(serviceNP.getType(),
            		serviceNP.getServiceSubType()));
        }
        catch (HomeException e)
        {
        	LogSupport.minor(ctx, this, "HomeException occurred while retrieveing Service Parameter Template for Service Type" 
					+ serviceNP.getType() + " and Service Sub Type " + serviceNP.getServiceSubType(), e);
        }
        if (template != null)
        {
        ...
        /*
         * This was copied from DefaultserviceNditorWebControl
         *
    ...
    public Object fromWeb(final Context ctx, final ServletRequest req, final String name)
    {
        ...
        syncServiceParameterField(serviceNP,serviceParamList);
     ...
     */
    private void syncServiceParameterField(final ServiceProduct serviceNP, final List serviceParameterList)
    {
        
    	serviceNP.setServiceParameters(serviceParameterList);
    }
