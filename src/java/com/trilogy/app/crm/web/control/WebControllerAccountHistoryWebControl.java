...
import com.trilogy.app.crm.web.action.AccountHistoryViewAction;
 ...
 */
public
class WebControllerAccountHistoryWebControl
    extends com.redknee.app.crm.web.control.WebControllerWebControl57
{
    /**
     * Creates a new WebController.
     */
    public WebControllerAccountHistoryWebControl(Class beanType)
    {
        super(beanType);
    }
        ...
        throws AgentException
    {
        ...
        list.add(new com.redknee.app.crm.web.action.InvoicePreviewAction(new SimplePermission(""), "previewPDF", "Invoice"));
        list.add(new com.redknee.app.crm.web.action.InvoicePreviewAction(new SimplePermission("invoice.tester"), "previewHTML", "HTML"));
        list.add(new AccountHistoryViewAction());
        ...
        final Class type)
    {
        ...
        controller.setTableWebControl(new AccountHistoryTableBoldWebControl());
