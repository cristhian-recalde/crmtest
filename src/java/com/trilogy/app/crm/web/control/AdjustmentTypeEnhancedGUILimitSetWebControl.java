...
/**
 * Web control for adjustment type enhanced GUI custom limit flag.
 * 
 * @author cindy.wong@redknee.com
 * @since 8.3
 */
public class AdjustmentTypeEnhancedGUILimitSetWebControl extends
        EnumWebControl
{

    public AdjustmentTypeEnhancedGUILimitSetWebControl()
    {
        super(AdjustmentTypeEnhancedGUILimitEnum.COLLECTION, false);
    }
    ...
    public void toWeb(Context ctx, PrintWriter out, String name, Object obj)
    {
        ...
        case CREATE_MODE:
             ...
             */
            if (bean.getPermission() != AdjustmentTypeEnhancedGUIPermissionEnum.ALLOWED_INDEX)
            {
             ...
             */
            out.print(" onChange=\"limitSetUpdate(event)\"");
