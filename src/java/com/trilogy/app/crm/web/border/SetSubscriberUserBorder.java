 ...
 */
public class SetSubscriberUserBorder implements Border, Validator
{	
	/* (non-Javadoc)
			...
			throws ServletException, IOException 
	{
		...
		subCtx.put(SubscriberHome.class, new ValidatingHome(this, (Home) subCtx.get(SubscriberHome.class)));
			...
			throws IllegalStateException
	{
		...
		if (sub ==null)
		{
			throw new IllegalStateException ("Unable to find subscriber through the border");
		}
		sub.setUser(principal.getId());
	}	
}