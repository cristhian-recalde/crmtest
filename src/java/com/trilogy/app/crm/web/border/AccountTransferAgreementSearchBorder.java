 ...
 *
 */
public class AccountTransferAgreementSearchBorder implements Border
{

    public AccountTransferAgreementSearchBorder(Context ctx)
    {    
    }
            ...
            throws ServletException, IOException
    {
            ...
            if ( account != null )
            {
                ...
                // allAccountIds.add("");
                subCtx.put(TransferContractSupport.TRANSFER_AGREEMENT_OWNER_ID, allAccountIds);
            }
