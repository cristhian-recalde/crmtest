...
import com.trilogy.app.crm.bean.InvoiceID;
import com.trilogy.app.crm.bean.InvoiceIdentitySupport;
 ...
 */
public class InvoiceAccountNoteWebBorder implements Border
{
			...
			throws ServletException, IOException 
	{
        ...
        if ((message != null))
        {
			...
			try 
			{
				InvoiceID id = (InvoiceID)InvoiceIdentitySupport.instance().fromStringID(primaryKey);
				Home invoiceHome = (Home) ctx.get(InvoiceHome.class);
				if (invoiceHome != null)
				{
					...
					Invoice invoice = (Invoice) invoiceHome.find(ctx, id);
					if (invoice != null)
					{
	...
	public void addNote(Context ctx, Invoice inv, String principal, String message) 
	{
    	Account acct;
		try 
		{
