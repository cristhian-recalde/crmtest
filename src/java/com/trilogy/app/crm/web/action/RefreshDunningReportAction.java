...
import com.trilogy.app.crm.dunning.visitor.reportgeneration.DunningReportRefreshReportVisitor;
...
public class RefreshDunningReportAction extends SimpleWebAction
{
     ...
     *            Label.
     */
    public RefreshDunningReportAction()
    {
        super("refresh", "Refresh");
    }


    public RefreshDunningReportAction(final Permission permission)
    {
        this();
    ...
    public void writeLink(Context ctx, PrintWriter out, Object bean, Link link, String action)
    {
        ...
        out.print("<a href=\"");
        link.write(out);
        out.print("\" onclick=\"try{return confirm('Proceed with the refreshing of the Dunning Report for ");
    ...
    public void execute(Context ctx) throws AgentException
    {
        ...
        try
        {
            ...
            if (dunningReport!=null)
            {
                ...
                {
                    DunningReportRefreshReportVisitor visitor = new DunningReportRefreshReportVisitor(ctx);
                    visitor.visit(ctx, dunningReport);
                }
                else
                {
                    String message = "Dunning Report cannot be refreshed because it's not in pending state.";
