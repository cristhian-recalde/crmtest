 ...
 * @author amedina
 */
public class DeleteInvoiceAction extends DeleteAction 
{
    public DeleteInvoiceAction()
    {
    }


    public DeleteInvoiceAction(Permission permission)
    {
        this();
    ...
    public Link modifyLink(Context ctx, Object bean, Link link)
    {
        ...
        link.add(InvoiceAccountNoteWebBorder.MESSAGE, " - Delete - ");
        return link;
    }
