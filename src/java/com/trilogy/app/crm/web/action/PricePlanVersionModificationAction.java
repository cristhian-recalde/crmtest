...
/**
 * Action responsible to save a price plan version modification request
 * @author Marcio Marques
 * @since 9.2
 */
public class PricePlanVersionModificationAction extends SimpleWebAction
{

	public static final String DEFAULT_KEY = "modify";
	 ...
	 */
	public PricePlanVersionModificationAction()
	{
	 ...
	 */
	public PricePlanVersionModificationAction(final String key, final String label)
	{
		super(key, label);
	}
