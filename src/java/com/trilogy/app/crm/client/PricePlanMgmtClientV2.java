 ...
 * @since 9.9.0
 */
public interface PricePlanMgmtClientV2 
{
     ...
     * </ul>
     */
    void mapPricePlan(Context ctx, final int spid, final String pricePlanId, final RatePlanType type, final String ratePlanId, 
     ...
     *
     */
    RatePlanInfo[] queryRatePlans(Context ctx, final int spid, final RatePlanType type, final String ratePlanIdPrefix, Parameter[] inParams, ParameterSetHolder outParams) throws PricePlanMgmtException;
