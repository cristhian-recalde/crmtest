...
import com.trilogy.app.urcs.provision.v2_0.PricePlanMgmt;
 ...
 * @since 9.9.0
 */
public class PricePlanMgmtCorbaClientV2 extends AbstractCrmClient<PricePlanMgmt>
implements PricePlanMgmtClientV2
{

	/**
	 * Name of the CORBA client.
	 */
	private static final String CLIENT_NAME = "PricePlanMgmtClientV2";
	...
	public PricePlanMgmtCorbaClientV2(final Context context)
	{
	...
	@Override
	public void mapPricePlan(Context ctx, int spid, String pricePlanId, RatePlanType type, String ratePlanId, 
			Parameter[] inParams, ParameterSetHolder outParams) throws PricePlanMgmtException 
	{
		final LogMsg pm =
		...
		try
		{
			...
			result = service.mapPricePlan(spid, pricePlanId, type, ratePlanId, inParams, outParams);
	 ...
	 */
	@Override
	public RatePlanInfo[] queryRatePlans(Context ctx, final int spid,
			final RatePlanType type, final String ratePlanIdPrefix, Parameter[] inParams, ParameterSetHolder outParams)
		...
		{
			result =
					service.queryRatePlans(spid, type, ratePlanIdPrefix, ratePlans, inParams, outParams);
