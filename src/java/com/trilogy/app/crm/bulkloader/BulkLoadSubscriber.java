 ...
 */
public class BulkLoadSubscriber extends AbstractBulkLoadSubscriber
{
    ...
    public static ThreadLocalSimpleDateFormat getDateFormat(final Context ctx)
    {
        ...
        final String format = mmgr.get(ctx, DateWebControl.MSG_MGR_KEY, BulkLoadSubscriber.class,
