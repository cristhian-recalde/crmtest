...
/**
 * Closes qualified de-activated finite balance subscriber (State Modification)
 * 
 * @author simar.singh@redknee.com
 * 
 */
public class SubscriberFiniteBalanceDormantToDeactivateAgent implements ContextAgent
{
    ...
    static final class CleanUpSpidSubscriberVisitor extends HomeVisitor
    {
        ...
        /**
         * For the given service provider, close all of its inactive subscribers which
        ...
        public void visit(final Context context, final Object object)
        {
            ...
            try
            {
                ...
                filteredHome.forEach(subcontext,
                        new CloneingVisitor(new CloseFiniteBalanceSubscriberVisitor(getHome())));
            }
    ...
    /**
     * Closes a subscriber-subscription if the subscriber's balance is below the threshold
     * set in the context.
     * 
     * @author simar.singh@redknee.com
     */
    static final class CloseFiniteBalanceSubscriberVisitor extends HomeVisitor
    {
        ...
        /**
         * Create a new instance of <code>DeactivatedDormantSubscriberVisitor</code>.
         * 
         * @param home
         *            The home to visit.
         */
        public CloseFiniteBalanceSubscriberVisitor(final Home home)
        {
            super(home);
            // add safeguard
            if (home == null)
        ...
        /**
         * If the subscriber has a remaining balance, write it off and finally set them to
         * closed state.
         * 
         * @param context
         *            The operating context.
         * @param object
         *            The subscriber to be close.
        ...
        public void visit(final Context context, final Object object)
        {
            ...
            try
            {
                context.put(SubscriptionDeactivateValidator.WRITE_OFF, true);
                sub.setState(SubscriberStateEnum.INACTIVE);
                getHome().store(context, sub);
            }
            catch (Throwable throwable)
            {
                new MinorLogMsg(this, "Couldn't close the Subscriper-Subscrption ID [" + sub.getId() + "]", throwable)
                        .log(context);
            }
        }
    }
