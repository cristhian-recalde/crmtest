...
/**
 * AppInstall Application Dependency Configuration Agent for AppVpn 
 * Configures:
 *  AppVpn corba client
 *  
 * @author ali
 *
 */
public class VpnInstallConfigAgent implements ContextAgent 
{
	...
	public void execute(Context context) throws AgentException 
	{
		...
		// Corba clients
		CorbaClientInstallConfigSupport.execute(context, "AppVpn", remote.getHostname());
    }
