...
/**
 * AppInstall Application Dependency Configuration Agent for AppHomezone 
 * Configures:
 *  AppHomezone corba clients
 *  
 * @author ali
 *
 */
public class AppHomezoneClientInstallConfig implements ContextAgent 
{
	...
	public void execute(Context context) throws AgentException 
    {
		...
		// Corba clients
		CorbaClientInstallConfigSupport.execute(context, "Homezone", remote.getHostname());
    }
