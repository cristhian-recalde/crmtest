...
/**
 * AppInstall Application Dependency Configuration Agent for AppSMSB 
 * Configures:
 *  AppSmsb corba client
 *  
 * @author ali
 *
 */
public class AppSmsbInstallConfigAgent implements ContextAgent 
{
	...
	public void execute(Context context) throws AgentException 
    {
		...
		// Corba clients
		CorbaClientInstallConfigSupport.execute(context, "SMSB", remote.getHostname());
    }
