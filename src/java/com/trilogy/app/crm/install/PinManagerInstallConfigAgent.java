 ...
 * Configures:
 *  AppPinManager corba client
 *  
 * @author ali
 *
 */
public class PinManagerInstallConfigAgent implements ContextAgent 
{
	...
	public void execute(Context context) throws AgentException 
	{
		...
		// Corba clients
		CorbaClientInstallConfigSupport.execute(context, "PinManager", remote.getHostname());
    }
