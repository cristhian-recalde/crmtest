...
import com.trilogy.app.crm.home.grr.ActiveVendorConfigSelectHome;
import com.trilogy.app.crm.home.grr.VendorConfigCheckHome;
 ...
 */
public class VendorConfigHomePipelineFactory implements PipelineFactory
{
            ...
            
    {
        ...
        Home home = CoreSupport.bindHome(ctx, VendorConfig.class);
          
        home = new VendorConfigCheckHome(ctx,home);
        
        home = new SortingHome(ctx,home);
        
        home = new ActiveVendorConfigSelectHome(ctx,home);
