 ...
 */
public class XSDVersionConfigHomePipelineFactory implements PipelineFactory
{
            ...
            
    {
        ...
        Home home = CoreSupport.bindHome(ctx, XSDVersionConfig.class);
          
        home = new XSDVersionConfigCheckHome(ctx,home);
