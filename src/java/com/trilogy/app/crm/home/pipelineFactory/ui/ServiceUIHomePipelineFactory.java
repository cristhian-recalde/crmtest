...
import com.trilogy.app.crm.bean.ui.ServiceUIAdapter;
 ...
 * 
 */
public class ServiceUIHomePipelineFactory implements PipelineFactory
{
    ...
    public Home createPipeline(final Context ctx, final Context serverCtx) throws HomeException, IOException,
            AgentException
    {
        LogSupport.info(ctx, this, "Installing the service UI home ");

        Home home = new ContextRedirectingHome(ctx, com.redknee.app.crm.bean.ServiceHome.class);
        
        // Add adapter to switch between GUI bean and core beans.
        home = new AdapterHome(ctx, home, new ServiceUIAdapter(ctx));
