...
import com.trilogy.app.crm.bean.GenericBeanBulkLoadTaskHome;
...
/**
 * Creates the home decorators pipeline for the Generic-Bean-Bulk-Load-Task
 * 
...
public class GenericBeanBulkLoaderPipelineFactory implements PipelineFactory
{
    ...
    public GenericBeanBulkLoaderPipelineFactory()
    {
        super();
    }
    ...
    {
        Home home = StorageSupportHelper.get(ctx).createHome(ctx, GenericBeanBulkLoadTask.class, "GENERICBEANBULKTASK");
        home = new LastModifiedAwareHome(home);
        home = new LastModifiedByAwareHome(home);
        home = new FileLoadingTypeAwareHome<GenericBeanBulkLoadTask>(GenericBeanBulkLoadTask.class, home);
        home = new BackgroundTaskAwareHome<GenericBeanBulkLoadTask>(GenericBeanBulkLoadTask.class, home);
        ctx.put(GenericBeanBulkLoadTaskHome.class, home);
        return home;
    }
}
