 ...
 * @since 2011-03-03
 */
public class OccupationHomePipelineFactory implements PipelineFactory
{
	...
	{
		Home home = CoreSupport.bindHome(ctx, Occupation.class);
		...
		home = new RMIClusteredHome(ctx, OccupationHome.class.getName(), home);
		home =
		    ConfigChangeRequestSupportHelper.get(ctx)
		        .registerHomeForConfigSharing(ctx, home, Occupation.class);
		return home;
	}
}
