...
/**
 * Sets the unique identifiers used by auxiliary services.
 *
 * @author gary.anderson@redknee.com
 */
public class AuxiliaryServiceIdentifierSettingHome extends HomeProxy
{
    /**
     * Creates a new AuxiliaryServiceIdentiferSettingHome proxy.
     *
     * @param delegate The Home to which we delegate.
     */
    public AuxiliaryServiceIdentifierSettingHome(final Home delegate)
    {
        super(delegate);
    }
    ...
    {
        final AuxiliaryService service = (AuxiliaryService)bean;
        ...
        throws HomeException
    {
        IdentifierSequenceSupportHelper.get(ctx).ensureSequenceExists(
            ctx,
            IdentifierEnum.AUXILIARY_SERVICE_ID,
            1,
            Long.MAX_VALUE);
