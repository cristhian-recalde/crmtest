 ...
 * @since 2011-03-03
 */
public class ProvinceHomePipelineFactory implements PipelineFactory
{
	...
	{
		Home home = CoreSupport.bindHome(ctx, Province.class);
		home = new ProvinceFieldsSettingHome(home);
		home =
		    ConfigChangeRequestSupportHelper.get(ctx)
		        .registerHomeForConfigSharing(ctx, home, Province.class);
		home = new NotifyingHome(home);
		home = new AuditJournalHome(ctx, home);
		home = new RMIClusteredHome(ctx, ProvinceHome.class.getName(), home);
