...
/**
 * A suite of test cases for the com.redknee.app.crm.home.validator package.
 *
...
public class TestPackage extends TestCase
{
    ...
    public static Test suite(final Context context)
    {
        ...
        suite.addTest(TestAuxiliaryServiceOneToOneServiceOptionValidator.suite(context));
