 ...
 *
 */
public class PromotionByNonZeroCharges 
    extends PromotionByMinCharges
{
    final static private int ZER0_CHARGE = 0;

    public PromotionByNonZeroCharges(PromotionBy delegate) {
        super(delegate, ZER0_CHARGE);
    }
}
