...
/**
 * Interface for adding new where clause for PromotionSearch 
 * and generating summaryBundle for UsageReport
 * Use PromotionProxy if possible for consistancy in where clause and generation behaviour 
 * 
 * @author kwong
 *
 */
public interface PromotionBy 
{
    public SummaryBundle    generate() throws HomeException;
