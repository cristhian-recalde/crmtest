 ...
 *
 */
public class PromotionByNonBucketUsage 
    extends PromotionByBucketRate
{
    final static private int nonBucketRate = 0;

	public PromotionByNonBucketUsage(PromotionBy delegate) {
		super(delegate, nonBucketRate);
	}
