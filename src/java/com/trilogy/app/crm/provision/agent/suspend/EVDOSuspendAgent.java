...
import com.trilogy.app.crm.provision.EVDOUnprovisionAgent;
    ...
    implements ContextAgent
{
        ...
        throws AgentException
    {
        ...
        {
            new DebugLogMsg(this," EVDO Suspend currently follows the same logic as Unprovision", null).log(context);
        }
        new EVDOUnprovisionAgent().execute(context);
    }
