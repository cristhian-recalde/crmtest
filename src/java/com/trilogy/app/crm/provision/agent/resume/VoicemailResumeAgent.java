...
import com.trilogy.app.crm.provision.VoicemailProvisionAgent;
 ...
 * 
 */
public class VoicemailResumeAgent extends CommonResumeAgent
{
    ...
    public void execute(Context ctx) throws AgentException
    {
        ...
        {   
            ...
            new VoicemailProvisionAgent().execute(ctx);
        }     
    }
}
