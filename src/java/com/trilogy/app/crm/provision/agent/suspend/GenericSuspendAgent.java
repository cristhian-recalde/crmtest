 ...
 */
public class GenericSuspendAgent extends CommonSuspendAgent
{

    /**
     * Suspends HLR services to HLR. Context must contain the subscriber to be
    ...
    public void execute(final Context ctx) throws AgentException
    {
        ...
        if (SystemSupport.needsHlr(ctx))
        {
             ...
             try
            {
                ...
                long response = ServiceProvisioningGatewaySupport.execute(subCtx, CommandID.SERVICE_SUSPEND,
