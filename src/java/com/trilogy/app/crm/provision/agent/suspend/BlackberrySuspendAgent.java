...
public class BlackberrySuspendAgent extends CommonSuspendAgent
{
    ...
    public void execute(Context ctx) throws AgentException
    {
        ...
        try
        {
            new SuspendBlackberryServiceUpdateAgent().update(ctx, subscriber, service);
        }
        catch (HomeException e)
        {
            throw new AgentException("BlackBerry service suspension failed: " + e.getMessage(), e);
        }
    }
}