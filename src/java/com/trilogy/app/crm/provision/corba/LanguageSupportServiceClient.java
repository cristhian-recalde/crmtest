...
public class LanguageSupportServiceClient extends ContextAwareSupport
{
   private LanguageSupportService service_;
    ...
    * @param ctx
    */
   public LanguageSupportServiceClient(Context ctx)
   {
      setContext(ctx);
      init();
   }
    ...
    * @param key
    */
   public LanguageSupportServiceClient(Context ctx, String key)
   {
      setContext(ctx);
      init(key);
   }
   ...
   private void init(String key) throws IllegalArgumentException
   {
      ...
      corbaClientPropertyHome =
         (Home) getContext().get(CorbaClientPropertyHome.class);
      ...
      {
         property_ =
            (CorbaClientProperty) corbaClientPropertyHome.find(getContext(), key);
      }
      catch (HomeException e)
      {
         new MinorLogMsg(this, e.getMessage(), e).log(getContext());
         throw new IllegalArgumentException(
               "Unable to load corba proxy for "
               + key
   ...
   private void initWithProperty()
   {
      if (property_ == null)
      {
         throw new IllegalArgumentException("Can't find ClientProperty for LanguageSupportServiceClient");
      }
    ...
    */
   public LanguageSupportService getService()
   {
      ...
      if (objServant != null)
      {
         try
         {
            ...
            service_ =
               LanguageSupportFactoryHelper.narrow(objServant).createLanguageSupportService(
                  username_,
                  password_);
            if (service_ != null)
            {
