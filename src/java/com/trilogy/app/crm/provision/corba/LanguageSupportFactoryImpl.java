 ...
 * @author lzou
 */
public class LanguageSupportFactoryImpl
   extends LanguageSupportFactoryPOA
   implements ContextAware
{
    ...
    * @param ctx
    */
   public LanguageSupportFactoryImpl(Context ctx)
   {
      super();
      setContext(ctx);
   }
    ...
    * @throws AuthError
    * 
    * @see com.redknee.app.crm.provision.corba.LanguageSupportServiceFactoryOperations#createEcareService(java.lang.String,java.lang.String)
    */
   public LanguageSupportService createLanguageSupportService(String login, String passwd)      
   {
      String uid = authenticateUser(login, passwd);

      LanguageSupportServiceImpl servant = new LanguageSupportServiceImpl(getContext(), uid);
      try
      {
         org.omg.CORBA.Object obj =
            _default_POA().servant_to_reference(servant);
         return LanguageSupportServiceHelper.narrow(obj);
      }
