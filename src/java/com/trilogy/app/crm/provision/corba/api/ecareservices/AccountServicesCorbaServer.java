...
public class AccountServicesCorbaServer extends CorbaServerInitService
{

    public AccountServicesCorbaServer(Context ctx)
    {
        super(ctx);
        
        ctx.put(AccountServicesFacade.class, new AccountServicesFacade()); 
    }
