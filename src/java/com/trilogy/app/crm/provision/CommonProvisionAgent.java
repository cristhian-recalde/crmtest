 ...
 */
public abstract class CommonProvisionAgent extends CommonProvisionAgentBase
{
    ...
    {
        SubscriberProvisionHlrGatewayHome.setMsisdnRemovedFromHlrGateway(ctx, sub, false);
        return false;
    }
            ...
            final com.redknee.app.crm.bean.Service service, String aMsisdn, String bearTypeId) throws ProvisionAgentException
    {
        ...
        if (result != 0)
        {
            throw new ProvisionAgentException(ctx, ExternalAppSupportHelper.get(ctx)
                    .getProvisionErrorMessage(ctx, ExternalAppEnum.HLR, result, service), result,
                    ExternalAppEnum.HLR);
        }
    }
