...
public class IsAttachmentPhotoWebActionPredicate
    implements Predicate
{
        ...
        throws AbortVisitException
    {
        ...
        try
        {
            if(AccountAttachmentSupport.getAccountMangement(ctx).getMaxNumberOfAttachments() < AccountAttachmentSupport.getNumberOfAttachmentsForBan(ctx, account.getBAN()))
            {
